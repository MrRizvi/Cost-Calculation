				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'unload' ),
							'description' => __( 'Upgrade Content and Settings', 'unload' ),
							'pending' => __( 'Pending.', 'unload' ),
							'installing' => __( 'Installing Updates.', 'unload' ),
							'success' => __( 'Success.', 'unload' ),
