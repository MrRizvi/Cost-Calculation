...
class unload_recent_news_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        $widget_ops = array(
            'description' => esc_html__('This widget is used to show blog posts.', 'unload')
        );
        $control_ops = array(
            'width' => 250,
            'height' => 350,
            'id_base' => 'unload-recent-news'
        );
        parent::__construct('unload-recent-news', esc_html__('Recent News Unload', 'unload'), $widget_ops, $control_ops);
    }

    public function widget($args, $instance)
    {
        extract($args);
        $defaults = array('title' => esc_html__('Recent News', 'unload'), 'subtitle' => esc_html__('Uniquely Pursue', 'unload'), 'number' => '3', 'category' => '');
                            ...
                            <div class="recent-news-desc">
                                <ul class="post-meta2">
                                    <li>
                                        ...
                                        <a content="<?php echo get_the_date(get_option('post_format')) ?>"
                                           itemprop="datePublished" title=""
                                           href="<?php echo esc_url(get_day_link($year, $month, $day)); ?>">
